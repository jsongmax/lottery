...
- **🌟 独家隐藏彩蛋与内定功能**：
  - **新郎新娘专属身份入口**：在手机端报名注册页，连续快速点击头部“✨ 婚礼幸运抽奖 ✨”标题区域 5 次，即可唤出隐藏的“新郎”与“新娘”身份选项，避免普通宾客误选，保证抽奖池的纯净和婚礼的主角光环！
  - **强制内定机制**：后台提供隐藏的管理员强制内定功能，确保重要奖项可受控分配（由于是隐藏功能，请通过特定接口或直接操作数据库的 `is_inner_winner` 字段来实现内定）。
